function[CM_normalized,average_recall,average_precision,falpha]= where_evaluation_happens_six_output(filename)
...
for i=0:9
    ...
    [confusionMatrix{i+1,1},recall{i+1,1}, precision{i+1,1}] = train_and_test_for_six_output(xTraining,xTest,yTraining,kk);
